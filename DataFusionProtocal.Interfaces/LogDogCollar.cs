...
namespace DataFusionProtocal.Interfaces
{
    public class LogDogCollar : ILogDogCollar
    {
        ...
        public void Setup(string baseDir, string dir, string logName, string level = "ALL")
        {
            _dir = dir;
            _logName = logName;
            ...
            if (repository == null)
            {
                ...
                var rollingAppender = CreateFileAppender(_logName + "Appender", Path.Combine(baseDir, "Logs", _dir, _logName));
            ...
            SetLevel(_logName + "logger", level);
        }
